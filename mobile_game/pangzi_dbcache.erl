...
%% generated by 'smerl' on {{2016,7,25},{11,47,59}}.

-module(pangzi_dbcache).
...
info(player_tab) ->
    {db_table_meta, player_tab, set,
     [id, name, career, level, hp, mp, longwens, pearl,
      ...
      combat_power, item_id, add_hp_mp_info],
     undefined, 3, false,
...
info(player_arena_tab) ->
    {db_table_meta, player_arena_tab, set,
     [id, name, career, power, arena_lev, high_arena_lev,
      arena_cent, award_state, trun_state, p2e_win, p2e_loss,
      p2p_win, p2p_loss, p2p_kill, m_p2p_win, m_p2p_loss,
      m_p2p_kill, m_p2p_die],
...
info(player_abyss_tab) ->
    {db_table_meta, player_abyss_tab, set,
     [player_id, easy_layer, auto_easy_layer, hard_layer,
      auto_hard_layer, daily_count, daily_reset, score,
      rankIndex],
     undefined, 10, false, undefined, false, [], 10, 30,
     undefined};
...
info(auction_log_tab) ->
    {db_table_meta, auction_log_tab, set,
     ...
     undefined};
info(com_auction_timeout_tab) ->
    {db_table_meta, com_auction_timeout_tab, set,
     [id, item_state, cfg_id, ver, item, item_type, seller,
      money_type, start_price, high_price, step_price,
      cur_price, bider_id, fee_rate, timeout, timer_ref],
     com_auction_tab, 3, false, undefined, true, [], 1, 30,
     undefined};
info(com_auction_tab) ->
    {db_table_meta, com_auction_tab, set,
     [id, item_state, cfg_id, ver, item, item_type, seller,
      money_type, start_price, high_price, step_price,
      cur_price, bider_id, fee_rate, timeout, timer_ref],
     com_auction_tab, 3, false, undefined, true, [], 1, 30,
...
info(sky_ins_service) ->
    {db_table_meta, sky_ins_service, set,
     ...
     undefined, false, [], 30, 30, undefined};
info(player_auction_table) ->
    {db_table_meta, player_auction_table, set,
     [id, ver, auction_bag], auction_tab, 3, false,
     undefined, true, [], 1, 30, undefined};
...
delete(com_auction_timeout_tab, Key) ->
    ets:delete(com_auction_timeout_tab, Key),
    com_auction_timeout_tab ! {delete, Key};
delete(com_auction_tab, Key) ->
    ets:delete(com_auction_tab, Key),
    com_auction_tab ! {delete, Key};
...
delete(player_auction_table, Key) ->
    ets:delete(player_auction_table, Key),
    player_auction_table ! {delete, Key};
...
update_element(com_auction_timeout_tab, Key, Op) ->
    case ets:update_element(com_auction_timeout_tab, Key,
			    Op)
	of
      true ->
	  com_auction_timeout_tab ! {update_element, Key}, true;
      false -> false
    end;
update_element(com_auction_tab, Key, Op) ->
    case ets:update_element(com_auction_tab, Key, Op) of
      true -> com_auction_tab ! {update_element, Key}, true;
      false -> false
    end;
...
update_element(player_auction_table, Key, Op) ->
    case ets:update_element(player_auction_table, Key, Op)
	of
      true ->
	  player_auction_table ! {update_element, Key}, true;
      false -> false
    end;
...
update_counter(auction_log_tab, Key, Op) ->
    ...
    R;
update_counter(com_auction_timeout_tab, Key, Op) ->
    R = ets:update_counter(com_auction_timeout_tab, Key,
			   Op),
    com_auction_timeout_tab ! {update_counter, Key, Op},
    R;
update_counter(com_auction_tab, Key, Op) ->
    R = ets:update_counter(com_auction_tab, Key, Op),
    com_auction_tab ! {update_counter, Key, Op},
    R;
...
update_counter(sky_ins_service, Key, Op) ->
    ...
    R;
update_counter(player_auction_table, Key, Op) ->
    R = ets:update_counter(player_auction_table, Key, Op),
    player_auction_table ! {update_counter, Key, Op},
    R;
...
insert_new(com_auction_timeout_tab, Obj) ->
    case ets:insert_new(com_auction_timeout_tab, Obj) of
      true ->
	  com_auction_timeout_tab ! {first_set, Obj}, true;
      false -> false
    end;
insert_new(com_auction_tab, Obj) ->
    case ets:insert_new(com_auction_tab, Obj) of
      true -> com_auction_tab ! {first_set, Obj}, true;
      false -> false
    end;
...
insert_new(player_auction_table, Obj) ->
    case ets:insert_new(player_auction_table, Obj) of
      true -> player_auction_table ! {first_set, Obj}, true;
      false -> false
    end;
...
update(com_auction_timeout_tab, Obj) ->
    OldData = get(com_auction_timeout_tab),
    if OldData =:= Obj -> pass;
       true ->
	   ets:insert(com_auction_timeout_tab, Obj),
	   com_auction_timeout_tab ! {set, Obj},
	   put(com_auction_timeout_tab, Obj)
    end;
update(com_auction_tab, Obj) ->
    OldData = get(com_auction_tab),
    if OldData =:= Obj -> pass;
       true ->
	   ets:insert(com_auction_tab, Obj),
	   com_auction_tab ! {set, Obj},
	   put(com_auction_tab, Obj)
    end;
...
update(player_auction_table, Obj) ->
    OldData = get(player_auction_table),
    if OldData =:= Obj -> pass;
       true ->
	   ets:insert(player_auction_table, Obj),
	   player_auction_table ! {set, Obj},
	   put(player_auction_table, Obj)
    end;
