...
AIDecisions =
{
    { denefit = 10, mutex = 5, events = { {type = "hitted", skillId = 0, count = 15, time = 20}}, conditions = {}, actions = {{ action = DoCastSkill(300602), number = 1 }}},
...
ChangeSkillRank(30, {{300601,10},{300602,60},{300603,30}})