...
AIDecisions =
{
    { denefit = 10, mutex = 5, events = { {type = "hitted", skillId = 0, count = 15, time = 20}}, conditions = {}, actions = {{ action = DoCastSkill(300622), number = 1 }}},
...
ChangeSkillRank(30, {{300621,10},{300622,60},{300623,30}})